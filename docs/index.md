...
这是基于 [Horizon](https://github.com/thysrael/Horizon) 定制的清美 GIX 备考信息雷达。它每天筛选智慧互联、交互设计和 621 美术设计史论素材，并把每条内容转成英语一微练习与手绘/视觉记忆任务。

> 使用原则：每天精读 2 条、手绘 1 条；新闻只做案例补充，不替代教材、真题和成体系训练。
...
This is a focused GIX preparation radar built on [Horizon](https://github.com/thysrael/Horizon). It turns selected intelligent-interaction and art/design-history updates into bilingual reading, English-I sentence work, and short sketch drills.
